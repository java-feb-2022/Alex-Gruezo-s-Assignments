...
<link href=
"https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.5.0/css/bootstrap-datepicker.css" rel="stylesheet"/>
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="col-12 col-md-8 mx-auto">
        	<form:form action="/projects/create" method="post" modelAttribute="newProject" class="p-4 bg-light text-primary">
